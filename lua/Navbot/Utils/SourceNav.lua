-- Based on sapphyrus's nav parser (github.com/sapphyrus); TF2 layout by moonverse
...
-- checksum cache so a mesh is never re-parsed
...
local function parse(raw, use_cache)
    ...
    for i = 1, self.areas_count do
        ...
        -- 'garbage' field (layout differs from CS:GO)
